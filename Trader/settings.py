...
ALLOWED_HOSTS = ['https://trader-cdja.onrender.com/','']
...
CRONJOBS = [
    ('0 0 * * *', 'predictor.management.commands.fetch_alphavantage'),  # Runs every day at midnight
    ('0 0 * * *', 'predictor.management.commands.fetch_google'),
